...
Theme URI: http://wordpress-511738-2008308.cloudwaysapps.com
Author: Cristian
Author URI: http://wordpress-511738-2008308.cloudwaysapps.com
...
(function($){
    ...
    //                         '<a href="https://wordpress-511738-2008308.cloudwaysapps.com/add-listing/">'+
    ...
    if ($(window).width() <1399) {
        temp_add_string_1='<li style="border-top: 1px solid #ddd;margin-top: 10px;padding-top: 10px;">'+
                            '<a href="https://wordpress-511738-2008308.cloudwaysapps.com">Categories</a>'+
                        '</li>'+
                        '<li>'+
                            '<a href="https://wordpress-511738-2008308.cloudwaysapps.com/messages/">Inbox</a>'+
                        '</li>'+
                        '<li>'+
                            '<a href="https://wordpress-511738-2008308.cloudwaysapps.com">App coming soon!</a>'+
                        '</li>'+
                        '<li>'+
                            '<a href="https://wordpress-511738-2008308.cloudwaysapps.com.au/join-today/">Partner with Hypley</a>'+
                        '</li>'+
                        '<li>'+
