	...
	<div class="container">
		<div class="row sticky-wrapper">
			...
			================================================== -->
						...
						if ($count_gallery > 0 && $gallery_style == 'content') : $template_loader->get_template_part('single-partials/single-listing', 'gallery-content');
						endif; ?>
						...
						<div id="un_verified_listing_widget" class="listing-widget widget listeo_core widget_listing_owner boxed-widget my_widget1">
							<div>
									...
									<div id="small-dialog" class="zoom-anim-dialog mfp-hide">
										...
										<div id="unverify_listing_msg_form" class="message-reply margin-top-0">
											<form>
												...
												<textarea required cols="40" id="contact-message" class="custommessage" name="message" rows="3" placeholder="<?php esc_attr_e('Your message', 'listeo_core'); ?>"></textarea>
								...
								if (get_option('listeo_claim_page_button')) {
									...
									$claim_page = get_option('listeo_claim_page'); ?>
									<div style="margin-top:80px;" class="claim_link">
										<p> Is this your Business ? <a href="<?php echo get_permalink($claim_page); ?>"><?php esc_html_e('Claim this listing!', 'listeo_core') ?></a> </p>
									</div>
	...
	<script>
		jQuery('#send_unverify_listing_msg_btn').on('click', function(e) {
			...
			jQuery.ajax({
				...
				url: ajax_file_url,
				data: {
					"action": "send_unverify_listing_msg",
					message: message,
