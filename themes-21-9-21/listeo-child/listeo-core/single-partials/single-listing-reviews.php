		...
		<div class="rating-bars">
			...
			<?php foreach ($criteria_fields as $key => $value) {
				...
				<div class="rating-bars-item">
					<span class="rating-bars-name"><?php echo esc_html($value['label']) ?> 
								<?php if(isset($value['tooltip']) && !empty($value['tooltip'])) : ?><i class="tip" data-tip-content="<?php echo esc_html($value['tooltip']); ?>"></i> <?php endif; ?></span>
