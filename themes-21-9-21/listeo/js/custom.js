	...
	this.each(function() {
		...
		if(dataRating > 0) {
	        ...
	        if (dataRating >= 4.75) {
	            ...
	            $(this).prepend(fourHalfStars);
	        } else if (dataRating >= 3.75) {
	            $(this).prepend(fourStars);
	        } else if (dataRating >= 3.25) {
	            $(this).prepend(threeHalfStars);
	        } else if (dataRating >= 2.75) {
	            $(this).prepend(threeStars);
	        } else if (dataRating >= 2.25) {
	            $(this).prepend(twoHalfStars);
	        } else if (dataRating >= 1.75) {
	            $(this).prepend(twoStars);
	        } else if (dataRating >= 1.25) {
	            $(this).prepend(oneHalfStar);
	        } else if (dataRating < 1.25) {
	            $(this).prepend(oneStar);
	        }
		}
	});
