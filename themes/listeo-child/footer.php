...
?>
<div id="footer" class="<?php echo esc_attr($style);
					...
					if (!get_option('listeo_disable_reviews')) {
						...
						if (isset($rating) && $rating > 0) :
							...
							<?php endif;
								...
								<div class="bsf-right">
									<a href="<?= ($verify) ? '#booking-widget-anchor' : '#un_verified_listing_widget' ?>" class="button"><?php if ($verify) {
																																			esc_html_e('Book Now', 'listeo');
																																		} else {
																																			echo "Message Now";
																																		} ?></a>
								</div>
	...
	<?php endif;
		...
		<div id="listeo_wishlist_popup" class="zoom-anim-dialog mfp-hide listeo-dialog ">
			<div class="small-dialog-header">
				<center>
					<h3 class="listeo_wishlist_header_title"> Your board </h3>
				</center>
			</div>
