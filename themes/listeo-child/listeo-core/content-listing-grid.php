         ...
         <div data-link="<?php the_permalink(); ?>" class="listing-item listeo_grid_view_item listo-list-iteam <?php if ($is_featured) { ?>featured-listing<?php } ?>">
            ...
            <?php if (is_user_logged_in()) { ?>
               ...
               <div class="listeo_custom_wishlist_main">
                  <a data-img_url="<?php echo $temp_get_first_img_url; ?>" id="listeo_add_to_wishlist_<?php echo $post->ID; ?>" <?php if (listeo_custom_check_if_wishlisted($post->ID)) {
                                                                                                                                    echo 'style="display:none;"';
                                                                                                                                 } ?> class="listeo_custom_wishlist_btn popup-with-zoom-anim" data-post_id="<?php echo esc_attr($post->ID); ?>" href="#listeo_wishlist_popup">
                  ...
                  <a id="listeo_remove_to_wishlist_<?php echo $post->ID; ?>" <?php if (listeo_custom_check_if_wishlisted($post->ID) == false) {
                                                                                 echo 'style="display:none;"';
                                                                              } ?> href="javascript:;" class="listeo_remove_to_wishlist" data-post_id="<?php echo esc_attr($post->ID); ?>">
