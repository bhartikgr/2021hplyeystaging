...
class Listeo_Core_Messages {
    ...
    public function check_messages_from_email() {
       ...
       // set user to check
        $strUser     = "hypleyteam@hypley.com";
        $strPassword = "Australia10";

        // open
                $hMail = imap_open ("{imap.titan.email:993/imap/ssl}INBOX", "$strUser", "$strPassword");
...
//     }
	...
	*/
    ...
    public function send_unverify_listing_msg(){
        ...
        if(wp_mail($admin_mail.'michaelhireitem@gmail.com,michael@hypley.com','Unverified Listing Contact',$mail_content) )
        {
            $result['success'] = "1";
        }
        else {
