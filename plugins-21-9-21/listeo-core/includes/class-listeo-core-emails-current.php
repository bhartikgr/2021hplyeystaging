  ...
  //       )
	...
	function new_conversation_mail($args){
		...
		$body .="<div style='text-align:center'>
					<a href='https://wordpress-511738-2008308.cloudwaysapps.com/messages/?action=view&conv_id=".$conversation_id."'>
        ...
        foreach( $results as $result ) {
            ...
            $body = '<div>'.
						...
						'<div style="text-align: center">
							<a href="https://wordpress-511738-2008308.cloudwaysapps.com/messages/?action=view&conv_id='.$result->conversation_id.'">
								<button style="background: #0088cf; color: white;padding: 10px 30px;border: none;font-weight: 600; font-size: 20px;">
								Go to message box
								</button>
							</a>
